import{s as v,a as k}from"./scrollUp-19a10485.js";const h=document.querySelector(".button-close"),L=document.querySelector(".btn-delete-favorites");document.querySelector(".btn-rating");const $=document.querySelector(".modal-card-container-f"),l=document.querySelector(".backdrop"),w=document.querySelector(".modal-window");let y,g=null;const C={defaultText:document.querySelector(".default_text")};h.addEventListener("click",p);window.addEventListener("keydown",m);l.addEventListener("click",f);function m(e){e.code==="Escape"&&p()}function f(e){e.target===l&&p()}function p(){console.log("hi"),l.classList.add("is-hidden"),window.removeEventListener("keydown",m),l.removeEventListener("click",f)}function E(e,t){h.addEventListener("click",p),window.addEventListener("keydown",m),l.addEventListener("click",f),g=e,console.log(e," to remove"),l.classList.remove("is-hidden"),console.log(" привіт це імпорт"),M(t);$.innerHTML=y,A()}function M(e){const t=localStorage.getItem("exerciseCard"),n=JSON.parse(t);return n.length?n.forEach(i=>{const{id:o,gifUrl:d,name:c,rating:a,target:r,bodyPart:S,equipment:b,popularity:_,burnedCalories:q,description:T}=i;if(o!=e){console.log("немає співпадіння");return}else return w.setAttribute("data-id",`${o}`),y=`      
